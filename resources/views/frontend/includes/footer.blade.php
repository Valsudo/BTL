        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
                <div class="footer__about__logo">
                    <a href="{{ route('frontend.user.dashboard') }}"><img src="{{ asset('img/logo/logo-bg.png') }}"
                            alt="" width="80px"></a>
                </div>
                <ul>
                    <li class="text-nowrap">@lang('Address: 175 Tay Son, Dong Da, Ha Noi')</li>
                    <li>@lang('Phone: +84 123 456 789')</li>
                    <li>@lang('Email:cccc@gmail.com')</li>
                </ul>
            </div>
        </div>
            ...
            <div class="footer__widget">
                <div class="pb-4">
                    <div id="map-container-google-2" class="z-depth-1-half map-container" style="height: 150px">
                        <iframe
                            src="https://maps.google.com/maps?q=Thuy%20Loi%20University,%20Hanoi,%20Vietnam&z=13&ie=UTF8&iwloc=&output=embed"
